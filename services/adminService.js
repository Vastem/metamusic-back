...
export default class AdminService{
    ...
    async updateAdmin(id, adminData){
        ...
        if(!adminToUpdate ) throw new NoDataFoundError("El administrador no existe")
    ...
    async deleteAdmin(id){
        ...
        if(!adminDeleted) throw new NoDataFoundError("El administrador no existe")
        return adminDeleted
    }
    ...
    async getAdmin(id){
        ...
        if(!admin) throw new NoDataFoundError("El administrador no existe")
        return admin
    }
